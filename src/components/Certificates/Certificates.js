        ...
        <section id="certificates">
            ...
            <div className="container mx-auto pt-12 py-5 px-6">
                <div className="w-full mb-15 lg:w-5/12">
                    <h1 className="text-xl text-deepBlue mb-5 font-semibold">KodeGO Certificate of Achievement</h1>
            ...
            <div className="container mx-auto pt-12 py-5 px-6">
                <div className="w-full mb-15 lg:w-5/12">
                    <h1 className="text-xl text-deepBlue mb-5 font-semibold">ICT Week Certificate of Appreciation</h1>
            ...
            <div className="container mx-auto pt-12 py-5 px-6">
                <div className="w-full mb-15 lg:w-5/12">
                    <h1 className="text-xl text-deepBlue mb-5 font-semibold">Certificate of Recognition, Hackathon</h1>
